...
// END генератор случайных имен

const friends = [
  { name: generateName(), online: true },
  { name: generateName(), online: false },
  { name: generateName(), online: false },
  { name: generateName(), online: true },
  { name: generateName(), online: false },
  { name: generateName(), online: true },
...
for (const friend of friends) {
  friend.nameLength = friend.name.length;
}

// console.table(friends);

////////////////////////////////////// Слить и суммировать 2 объекта с одинаковым lable
// const stats = [
...
//     this[element.label] = { id: element.id, label: element.label, percentage: 0 };
//     result.push(this[element.label]);
//   }
//   this[element.label].percentage += element.percentage;
// }, Object.create(null));

// console.log(result);

////////////////////////////////////// Генератор рандомных HEX цветов
